<?php
/**
 * The template for displaying newest posts archive
 * Template Name: Newest Page
 * @package Hot_News
 */

get_header();

// Set up custom query for newest posts
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">
                    <?php esc_html_e('Tin mới nhất', 'hot-news'); ?>
                </li>
            </ol>
        </nav>
    </div>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="archive-header mb-4">
                        ...
                        <p class="archive-description text-muted">
                            <?php esc_html_e('Cập nhật những tin tức mới nhất và nóng hổi nhất', 'hot-news'); ?>
                        </p>
                    </div>
                    ...
                    <?php if ($newest_query->have_posts()) : ?>
                        ...
                        <div id="news-feed-container" class="news-feed-items">
                            ...
                            $post_count = 0;
                            $posts_shown = 0;
                            while ($newest_query->have_posts() && $posts_shown < 5) : // Only show first 5 posts initially
                        ...
                        <div class="load-more-section text-center">
                            <?php if ($newest_query->max_num_pages > 1) : ?>
                                <button id="load-more-btn" class="btn btn-outline-primary btn-lg" 
                                        data-page="2" 
                                        data-max-pages="<?php echo $newest_query->max_num_pages; ?>"
                                        data-archive-type="newest">
                    ...
                    <?php else : ?>
                        ...
                        <div class="no-results">
                            <div class="text-center py-5">
                                ...
                                <p class="text-muted"><?php esc_html_e('Hiện tại chưa có tin tức mới nào. Hãy quay lại sau.', 'hot-news'); ?></p>
